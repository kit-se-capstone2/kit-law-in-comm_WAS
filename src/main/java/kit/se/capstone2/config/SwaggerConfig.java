	...
	public OpenAPI openAPI() {
		...
		Info info = new Info()
				...
				.description("""
								...
								2. 프론트엔드에서 image 태그의 src 방식으로 사진을 조회하기 위해서는 https://kit-law-in-comm-image.s3.ap-northeast-2.amazonaws.com 뒤에 붙여서 사용해야 함
								3. ex) https://kit-law-in-comm-image.s3.ap-northeast-2.amazonaws.com/2025/3/25/b1c2d6192ab14fcaa284a0d5d34638de.jpg
						""");
